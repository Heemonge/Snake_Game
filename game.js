var Snake = (function () {
    ...
    var game = {
        reset: function() {
            ctx.fillStyle = 'grey';
            ctx.fileRect(0, 0, canv.width, canv.height);
        ...
        log: function () {
            ...
            function HitWall() {
                ...
                ctx.fillStyle = 'grey';
                ctx.fileRect(0,0,gridSize-1,canv.height);
                ctx.fileRect(0,0,canv.width,gridSize-1);
                ctx.fileRect(canv.width-gridSize+1,0,gridSize,canv.height);
                ctx.fileRect(0,canv.height-gridSize+1,canv.width,gridSize);
            }
            ...
            if(!stopped) {
                ...
                ctx.fileText("(esc) reset", 24, 356);
                ctx.fileText("(space) pause", 24, 374);
            }

            ctx.fillStyle = 'green';
            for(var i=0; i<trail.length-1; i++) {
                ctx.fileRect(trail[i].x * gridSize+1, 
